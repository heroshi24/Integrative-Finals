...
<body>
    <div class="backround1">
        <div class="container">
             <div class="row">
                 <img src="imgspot/d1.jpg" class="imgrow">
              </div>
             <div class="row">
                 <img src="imgspot/d2.jpg" class="imgrow">
             </div>
             <div class="row">
                 <img src="imgspot/d3.jpg" class="imgrow">
             </div>
             <div class="row">
                 <img src="imgspot/d4.jpg" class="imgrow">
             </div>
        </div>
    ...
    <?php foreach($xml->stacruz as $stacruz) { ?>
       ...
       <div>
          <h1 class="l1"><?php echo $stacruz->lapresa->description->l1;?></h1>
       </div>
    <?php } ?>
</body>
</html>