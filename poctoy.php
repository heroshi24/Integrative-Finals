...
<body>
    <div class="backround6">
        <div class="container">
             <div class="row">
                 <img src="imgspot/u1.jpg" class="imgrow">
              </div>
             <div class="row">
                 <img src="imgspot/u2.jpg" class="imgrow">
             </div>
             <div class="row">
                 <img src="imgspot/u3.jpg" class="imgrow">
             </div>
             <div class="row">
                 <img src="imgspot/u4.jpg" class="imgrow">
             </div>
        </div>
    ...
    <?php foreach($xml->torrijos as $torrijos) { ?>
       ...
       <div>
          <h1 class="l1"><?php echo $torrijos->poctoybeach->description->l1;?></h1>
       </div>
    <?php } ?>
</body>
</html>