...
<body>
    <div class="backround6">
        <div class="container">
             <div class="row">
                 <img src="imgspot/v1.jpg" class="imgrow">
              </div>
             <div class="row">
                 <img src="imgspot/v2.jpg" class="imgrow">
             </div>
             <div class="row">
                 <img src="imgspot/v3.jpg" class="imgrow">
             </div>
             <div class="row">
                 <img src="imgspot/v4.jpg" class="imgrow">
             </div>
        </div>
    ...
    <?php foreach($xml->torrijos as $torrijos) { ?>
       ...
       <div>
          <h1 class="l1"><?php echo $torrijos->strawberryfarm->description->l1;?></h1>
       </div>
    <?php } ?>
</body>
</html>