...
<body>
    <div class="backround6">
        <div class="container">
             <div class="row">
                 <img src="imgspot/x1.jpg" class="imgrow">
              </div>
             <div class="row">
                 <img src="imgspot/x2.jpg" class="imgrow">
             </div>
             <div class="row">
                 <img src="imgspot/x3.jpg" class="imgrow">
             </div>
             <div class="row">
                 <img src="imgspot/x4.jpg" class="imgrow">
             </div>
        </div>
    ...
    <?php foreach($xml->torrijos as $torrijos) { ?>
       ...
       <div>
          <h1 class="l1"><?php echo $torrijos->pulanglupa->description->l1;?></h1>
       </div>
    <?php } ?>
</body>
</html>