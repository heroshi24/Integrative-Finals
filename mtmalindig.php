...
<body>
    <div class="backround5">
        <div class="container">
             <div class="row">
                 <img src="imgspot/t1.jpg" class="imgrow">
              </div>
             <div class="row">
                 <img src="imgspot/t2.jpg" class="imgrow">
             </div>
             <div class="row">
                 <img src="imgspot/t3.jpg" class="imgrow">
             </div>
             <div class="row">
                 <img src="imgspot/t4.jpg" class="imgrow">
             </div>
        </div>
    ...
    <?php foreach($xml->buenavista as $buenavista) { ?>
       ...
       <div>
          <h1 class="l1"><?php echo $buenavista->mtmalindig->description->l1;?></h1>
       </div>
    <?php } ?>
</body>
</html>